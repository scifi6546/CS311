// counthar_test_main.cpp
// Glenn G. Chappell
// 2019-10-01
//
// For CS 311 Fall 2019
// Tests for function countHAR: main program
// For Project 4, Exercise A
// Uses the "Catch" unit-testing framework, version 2
// Requires counthar_test_suites.cpp, catch.hpp, counthar.h,
//  counthar.cpp
...
int main(int argc,
         char *argv[])
{
    const std::string tname = "function countHAR"
                              " - CS 311 Proj 4, Ex A";
